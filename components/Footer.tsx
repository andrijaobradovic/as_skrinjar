    ...
    <footer className="border-t bg-muted/30">
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 text-center sm:px-6 md:grid-cols-3 md:text-left">
        ...
        <div className="flex flex-col items-center space-y-3 md:items-start">
          ...
          <ul className="flex flex-col items-center space-y-2 text-sm text-muted-foreground md:items-start">
      ...
      <div className="border-t">
        <div className="mx-auto max-w-6xl px-4 py-4 text-center sm:px-6 md:text-left">
